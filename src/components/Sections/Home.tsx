    ...
    return(
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-0 w-10/12 mx-auto" id="home">
          <div className="flex flex-col gap-8 mt-8 lg:mt-24 items-center lg:items-start">
            ...
            <span className="text-center lg:text-start">Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br /> Sed sed blandit neque. Praesent vestibulum nisi massa. <br /> Quisque sit amet sapien metus. </span>
